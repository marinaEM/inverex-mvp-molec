# Foundation Model Results: Gene-Aware Expression Encoder
...
*Results below are from the model that completed within the 2-hour CPU time limit. See `results/foundation_full/` for raw data.*
...
| C. LightGBM 212 + mutations/clinical | 0.624 | - | Known baseline |
...
### Results
- `results/foundation_full/pretrain_history*.csv` -- Training loss curves
- `results/foundation_full/lodo_results.csv` -- LODO evaluation per dataset
- `results/foundation_full/ablation_input_encoding.csv` -- Encoding ablation
- `results/foundation_full/ablation_objectives.csv` -- Objectives ablation
- `results/foundation_full/ablation_model_size.csv` -- Model size ablation
- `results/foundation_full/ablation_frozen_vs_finetuned.csv` -- Frozen/finetuned ablation
- `results/foundation_full/embedding_analysis.csv` -- Embedding quality metrics
- `results/foundation_full/comparison_vs_baselines.csv` -- Final comparison table

### Documentation
- `docs/foundation_model_mini_vs_full.md` -- Mini vs full comparison
- `docs/foundation_model_training_data.md` -- Training data documentation
- `docs/foundation_model_results.md` -- This document
